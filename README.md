...
Le recueil des données s'effectue en collaboration avec des associations partenaires, selon le processus suivant :

1. **Déclaration** : Une victime signale son cas auprès d'une association partenaire.
...
- Centraliser les données sur les violences basées sur le genre en Guinée
...
Ce projet est libre et ouvert à toute contribution. N'hésitez pas à ouvrir une *issue* ou soumettre une *pull request*.